...
def draw_task_automation(year='2020', job='TOTAL AVERAGE'):
    #### TASK AUTOMATION ####
    ...
    if (year=='2020') or (year=='2008'):        
        ...
        for i, obj in enumerate(objects):
            if ((obj =='Job Automation Index') or (obj =='Race with the Machine') or (obj =='Changing the Course of the Race') or 
        ...
        if len(objects) == 2:
            ...
            for i, obj in enumerate(objects):
                if ((obj =='Job Automation Index Change') or (obj =='Race with the Machine Change') or (obj =='Changing the Course of the Race Change') or 
            ...
            if ((objects[0] =='Job Automation Index') or (objects[0] =='Race with the Machine') or (objects[0] =='Changing the Course of the Race') or 
            ...
            elif ((objects[0] =='Job Automation Index Change') or (objects[0] =='Race with the Machine Change') or (objects[0] =='Changing the Course of the Race Change') or 
...
def draw_task_importance(year='2020', job='TOTAL AVERAGE'):    
    #### TASK IMPORTANCE ####    
    ...
    if year =='2020' or year=='2008':
        ...
        """
        labels = np.array(['Race ahead of the Machine', 'Race with the Machine', 'Running a Different Race', 'Race against the Machine', 'Changing the Course of the Race',]) 
...
"""
# Create your views here.
def draw_task_importance(year='2008~2020', job='TOTAL AVERAGE'):    
    #### TASK IMPORTANCE ####    
    csvpath = djangoSettings.STATICFILES_DIRS[0] +'/data/csv/Panel 2.csv'
    panel_df = pd.read_csv(csvpath, encoding='utf-8', dtype={'Year':str})
    labels = np.array(["Hazardous and Group Task","Outdoor Labor", "Dynamic Physical Task", "Physical Task", 
